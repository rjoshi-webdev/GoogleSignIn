...
class Plugin {
	...
	public function run(): void {
		...
		$this->url          = plugin_dir_url( trailingslashit( dirname( __FILE__, 2 ) ) . 'rj-google-signin.php' );
		 ...
		 * @since 1.0.0
		 */
		$this->active_modules = apply_filters( 'RjoshiWebdev.google_signin_modules', $this->active_modules );
	...
	public function load_translations(): void {
		load_plugin_textdomain( 'rj-google-signin', false, basename( plugin()->path ) . '/languages/' . get_locale() );
	}
